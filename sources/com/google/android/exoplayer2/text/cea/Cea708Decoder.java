    ...
    private static final class CueBuilder {
        ...
        public void defineWindow(boolean visible2, boolean rowLock2, boolean columnLock, int priority2, boolean relativePositioning2, int verticalAnchor2, int horizontalAnchor2, int rowCount2, int columnCount, int anchorId2, int windowStyleId2, int penStyleId2) {
            ...
            if (this.rowCount != rowCount2 + 1) {
                ...
                while (true) {
                    if ((!rowLock2 || this.rolledUpCaptions.size() < this.rowCount) && this.rolledUpCaptions.size() < 15) {
                        break;
                    }
                    this.rolledUpCaptions.remove(0);
                }
            }
            if (!(windowStyleId2 == 0 || this.windowStyleId == windowStyleId2)) {
                this.windowStyleId = windowStyleId2;
                int windowStyleIdIndex = windowStyleId2 - 1;
            ...
            if (penStyleId2 != 0 && this.penStyleId != penStyleId2) {
                this.penStyleId = penStyleId2;
                int penStyleIdIndex = penStyleId2 - 1;
