...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text2) {
        return new TtmlNode((String) null, TtmlRenderUtil.applyTextElementSpacePolicy(text2), C.TIME_UNSET, C.TIME_UNSET, (TtmlStyle) null, (String[]) null, "");
    }
    ...
    public List<Cue> getCues(long timeUs, Map<String, TtmlStyle> globalStyles, Map<String, TtmlRegion> regionMap) {
        ...
        for (Map.Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            ...
            cues.add(new Cue(cleanUpText(entry.getValue()), (Layout.Alignment) null, region.line, region.lineType, region.lineAnchor, region.position, Integer.MIN_VALUE, region.width));
        }
        return cues;
    }
