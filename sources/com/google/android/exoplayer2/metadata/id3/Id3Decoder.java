...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static Id3Header decodeHeader(ParsableByteArray data) {
        ...
        if (majorVersion == 2) {
            ...
            if ((flags & 64) != 0) {
                hasExtendedHeader2 = true;
            } else {
                hasExtendedHeader2 = false;
            }
    ...
    private static Id3Frame decodeFrame(int majorVersion, ParsableByteArray id3Data, boolean unsignedIntFrameSizeHack, int frameHeaderSize, FramePredicate framePredicate2) {
        int frameSize;
        Id3Frame frame;
        ...
        if (nextFramePosition > id3Data.limit()) {
            ...
            id3Data.setPosition(id3Data.limit());
            return null;
        } else if (framePredicate2 == null || framePredicate2.evaluate(majorVersion, frameId0, frameId1, frameId2, frameId3)) {
    ...
    private static CommentFrame decodeCommentFrame(ParsableByteArray id3Data, int frameSize) throws UnsupportedEncodingException {
        ...
        if (textStartIndex < data2.length) {
            text = new String(data2, textStartIndex, indexOfEos(data2, textStartIndex, encoding) - textStartIndex, charset);
        } else {
            text = "";
        }
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray id3Data, int frameSize, int majorVersion, boolean unsignedIntFrameSizeHack, int frameHeaderSize, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        while (id3Data.getPosition() < limit) {
            Id3Frame frame = decodeFrame(majorVersion, id3Data, unsignedIntFrameSizeHack, frameHeaderSize, framePredicate2);
            if (frame != null) {
                subFrames.add(frame);
            }
        }
