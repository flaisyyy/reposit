...
public final class DataSpec {
    ...
    public DataSpec(Uri uri2, byte[] postBody2, long absoluteStreamPosition2, long position2, long length2, @Nullable String key2, int flags2) {
    ...
    public DataSpec subrange(long offset, long length2) {
        ...
        return new DataSpec(this.uri, this.postBody, this.absoluteStreamPosition + offset, this.position + offset, length2, this.key, this.flags);
    }
}
