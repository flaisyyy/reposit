...
public final class UdpDataSource implements DataSource {
    ...
    public UdpDataSource(TransferListener<? super UdpDataSource> listener2) {
        this(listener2, 2000);
    }

    public UdpDataSource(TransferListener<? super UdpDataSource> listener2, int maxPacketSize) {
        this(listener2, maxPacketSize, 8000);
    }

    public UdpDataSource(TransferListener<? super UdpDataSource> listener2, int maxPacketSize, int socketTimeoutMillis2) {
