...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        DefaultKeyStatus(int statusCode2, byte[] keyId2) {
    ...
    public static final class DefaultKeyRequest implements KeyRequest {
        ...
        public DefaultKeyRequest(byte[] data2, String defaultUrl2) {
            this.data = data2;
    ...
    public static final class DefaultProvisionRequest implements ProvisionRequest {
        ...
        public DefaultProvisionRequest(byte[] data2, String defaultUrl2) {
            this.data = data2;
            this.defaultUrl = defaultUrl2;
        }
