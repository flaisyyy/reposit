...
public final class DummySurface extends Surface {
    ...
    public static DummySurface newInstanceV17(Context context, boolean secure2) {
        ...
        if (!secure2 || isSecureSupported(context)) {
            z = true;
        } else {
            z = false;
        }
    ...
    private static class DummySurfaceThread extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
        ...
        private void initInternal(int secureMode) {
            ...
            Assertions.checkState(EGL14.eglChooseConfig(this.display, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12327, 12344, 12339, 4, 12344}, 0, configs, 0, 1, numConfigs, 0) && numConfigs[0] > 0 && configs[0] != null, "eglChooseConfig failed");
            ...
            if (secureMode == 1) {
                ...
                surface2 = this.pbuffer;
            }
            Assertions.checkState(EGL14.eglMakeCurrent(this.display, surface2, surface2, this.context), "eglMakeCurrent failed");
