...
public final class MpegAudioHeader {
    ...
    public static int getFrameSize(int header) {
        ...
        return (((layer == 1 ? DefaultOggSeeker.MATCH_RANGE : 144000) * bitrate2) / samplingRate) + padding;
    }
    ...
    public static boolean populateHeader(int headerData, MpegAudioHeader header) {
        ...
        if (layer == 3) {
            ...
            frameSize2 = (((layer == 1 ? DefaultOggSeeker.MATCH_RANGE : 144000) * bitrate2) / sampleRate2) + padding;
        }
