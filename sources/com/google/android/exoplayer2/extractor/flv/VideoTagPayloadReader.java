...
final class VideoTagPayloadReader extends TagPayloadReader {
    ...
    public void parsePayload(ParsableByteArray data, long timeUs) throws ParserException {
        ...
        if (packetType == 0 && !this.hasOutputFormat) {
            ...
            this.output.format(Format.createVideoSampleFormat((String) null, MimeTypes.VIDEO_H264, (String) null, -1, -1, avcConfig.width, avcConfig.height, -1.0f, avcConfig.initializationData, -1, avcConfig.pixelWidthAspectRatio, (DrmInitData) null));
            ...
            this.output.sampleMetadata(timeUs2, this.frameType == 1 ? 1 : 0, bytesWritten, 0, (TrackOutput.CryptoData) null);
        }
    }
}
