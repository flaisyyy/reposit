...
public final class MatroskaExtractor implements Extractor {
        ...
        switch (id) {
            ...
            case ID_SIMPLE_BLOCK /*163*/:
                ...
                if (this.blockState == 1) {
                    ...
                    if (track.type == 2 || (id == ID_SIMPLE_BLOCK && (this.scratch.data[2] & 128) == 128)) {
                        i = 1;
                    } else {
                        i = 0;
                    }
    ...
    private static void setSampleDuration(byte[] subripSampleData, long durationUs2, String timecodeFormat, int endTimecodeOffset, long lastTimecodeValueScalingFactor, byte[] emptyTimecode) {
        ...
        if (durationUs2 == C.TIME_UNSET) {
            ...
            long durationUs3 = durationUs2 - (((long) (hours * 3600)) * C.MICROS_PER_SECOND);
            int minutes = (int) (durationUs3 / 60000000);
            long durationUs4 = durationUs3 - (((long) (minutes * 60)) * C.MICROS_PER_SECOND);
            int seconds = (int) (durationUs4 / C.MICROS_PER_SECOND);
            int lastValue = (int) ((durationUs4 - (((long) seconds) * C.MICROS_PER_SECOND)) / lastTimecodeValueScalingFactor);
    ...
    private static final class Track {
        ...
        public void initializeOutput(ExtractorOutput output2, int trackId) throws ParserException {
            ...
            if (MimeTypes.isAudio(mimeType)) {
                type2 = 1;
                format = Format.createAudioSampleFormat(Integer.toString(trackId), mimeType, (String) null, -1, maxInputSize, this.channelCount, this.sampleRate, pcmEncoding, initializationData, this.drmInitData, selectionFlags, this.language);
                ...
                format = Format.createVideoSampleFormat(Integer.toString(trackId), mimeType, (String) null, -1, maxInputSize, this.width, this.height, -1.0f, initializationData, -1, pixelWidthHeightRatio, this.projectionData, this.stereoMode, colorInfo, this.drmInitData);
                ...
                format = Format.createTextSampleFormat(Integer.toString(trackId), mimeType, (String) null, -1, selectionFlags, this.language, -1, this.drmInitData, Long.MAX_VALUE, arrayList);
                ...
                type2 = 3;
                format = Format.createImageSampleFormat(Integer.toString(trackId), mimeType, (String) null, -1, initializationData, this.language, this.drmInitData);
            } else {
