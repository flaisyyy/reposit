...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        if (!(this.format != null && frameInfo.channelCount == this.format.channelCount && frameInfo.sampleRate == this.format.sampleRate && frameInfo.mimeType == this.format.sampleMimeType)) {
            this.format = Format.createAudioSampleFormat(this.trackFormatId, frameInfo.mimeType, (String) null, -1, -1, frameInfo.channelCount, frameInfo.sampleRate, (List<byte[]>) null, (DrmInitData) null, 0, this.language);
