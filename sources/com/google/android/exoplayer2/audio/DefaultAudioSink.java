...
public final class DefaultAudioSink implements AudioSink {
    ...
    public DefaultAudioSink(@Nullable AudioCapabilities audioCapabilities2, AudioProcessor[] audioProcessors2) {
        ...
        this.availableAudioProcessors = new AudioProcessor[(audioProcessors2.length + 4)];
        ...
        this.availableAudioProcessors[2] = this.trimmingAudioProcessor;
        System.arraycopy(audioProcessors2, 0, this.availableAudioProcessors, 3, audioProcessors2.length);
        this.availableAudioProcessors[audioProcessors2.length + 3] = this.sonicAudioProcessor;
    ...
    public void configure(int inputEncoding, int inputChannelCount, int inputSampleRate2, int specifiedBufferSize, @Nullable int[] outputChannels, int trimStartSamples, int trimEndSamples) throws AudioSink.ConfigurationException {
        int channelConfig2;
        long j;
        boolean flush = false;
        this.inputSampleRate = inputSampleRate2;
        int channelCount = inputChannelCount;
        int sampleRate2 = inputSampleRate2;
        ...
        boolean processingEnabled2 = this.isInputPcm && inputEncoding != 4;
        if (processingEnabled2) {
            ...
            while (i < length) {
                ...
                try {
                    flush |= audioProcessor.configure(sampleRate2, channelCount, encoding);
        ...
        switch (channelCount) {
            ...
            case 7:
                ...
                break;
            case 8:
                channelConfig2 = C.CHANNEL_OUT_7POINT1_SURROUND;
                break;
            default:
        ...
        if (flush || !isInitialized() || this.outputEncoding != encoding || this.sampleRate != sampleRate2 || this.channelConfig != channelConfig2) {
            reset();
            ...
            if (specifiedBufferSize != 0) {
                ...
                int minBufferSize = AudioTrack.getMinBufferSize(sampleRate2, channelConfig2, this.outputEncoding);
    ...
    public PlaybackParameters setPlaybackParameters(PlaybackParameters playbackParameters2) {
        ...
        if (!isInitialized() || this.processingEnabled) {
            ...
            if (!playbackParameters3.equals(lastSetPlaybackParameters)) {
                if (isInitialized()) {
            ...
            PlaybackParameters playbackParameters4 = playbackParameters3;
            ...
            if (!needsPassthroughWorkarounds() && systemClockUs - this.lastTimestampSampleTimeUs >= 500000) {
                ...
                if (this.audioTimestampSet) {
                    ...
                    if (audioTimestampUs < this.resumeSystemTimeUs) {
                        ...
                        String message = "Spurious audio timestamp (system clock mismatch): " + audioTimestampFramePosition + ", " + audioTimestampUs + ", " + systemClockUs + ", " + playbackPositionUs + ", " + getSubmittedFrames() + ", " + getWrittenFrames();
                        ...
                        String message2 = "Spurious audio timestamp (frame position mismatch): " + audioTimestampFramePosition + ", " + audioTimestampUs + ", " + systemClockUs + ", " + playbackPositionUs + ", " + getSubmittedFrames() + ", " + getWrittenFrames();
                        if (failOnSpuriousAudioTimestamp) {
    ...
    private AudioTrack initializeAudioTrack() throws AudioSink.InitializationException {
        ...
        if (Util.SDK_INT >= 21) {
            ...
            if (this.audioSessionId == 0) {
                audioTrack2 = new AudioTrack(streamType, this.sampleRate, this.channelConfig, this.outputEncoding, this.bufferSize, 1);
            } else {
                audioTrack2 = new AudioTrack(streamType, this.sampleRate, this.channelConfig, this.outputEncoding, this.bufferSize, 1, this.audioSessionId);
            }
        }
    ...
    private static class AudioTrackUtil {
        ...
        public void reconfigure(AudioTrack audioTrack2, boolean needsPassthroughWorkaround2) {
