...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public EventDispatcher(@Nullable Handler handler2, @Nullable MediaSourceEventListener listener2) {
            this(handler2, listener2, 0);
        }

        public EventDispatcher(@Nullable Handler handler2, @Nullable MediaSourceEventListener listener2, long mediaTimeOffsetMs2) {
            this.handler = listener2 != null ? (Handler) Assertions.checkNotNull(handler2) : null;
            this.listener = listener2;
            this.mediaTimeOffsetMs = mediaTimeOffsetMs2;
        }

        public EventDispatcher copyWithMediaTimeOffsetMs(long mediaTimeOffsetMs2) {
            return new EventDispatcher(this.handler, this.listener, mediaTimeOffsetMs2);
        }
        ...
        public void loadCompleted(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCompleted(dataSpec, dataType, -1, (Format) null, 0, (Object) null, C.TIME_UNSET, C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadCanceled(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCanceled(dataSpec, dataType, -1, (Format) null, 0, (Object) null, C.TIME_UNSET, C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadError(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded, IOException error, boolean wasCanceled) {
            loadError(dataSpec, dataType, -1, (Format) null, 0, (Object) null, C.TIME_UNSET, C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded, error, wasCanceled);
        }
