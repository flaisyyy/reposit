...
public final class SingleSampleMediaChunk extends BaseMediaChunk {
    ...
    public SingleSampleMediaChunk(DataSource dataSource, DataSpec dataSpec, Format trackFormat, int trackSelectionReason, Object trackSelectionData, long startTimeUs, long endTimeUs, int chunkIndex, int trackType2, Format sampleFormat2) {
    ...
    public void load() throws IOException, InterruptedException {
        try {
            ...
            trackOutput.sampleMetadata(this.startTimeUs, 1, this.bytesLoaded, 0, (TrackOutput.CryptoData) null);
